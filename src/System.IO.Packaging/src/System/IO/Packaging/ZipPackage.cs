...
namespace System.IO.Packaging
{
    ...
    public sealed class ZipPackage : Package
    {
        ...
        {
            return String.Concat(PackUriHelper.ForwardSlashChar, zipItemName);
        }
        ...
        private bool IsZipItemValidOpcPartOrPiece(string zipItemName)
        {
            ...
            else
            {
                ...
                if (zipItemName.StartsWith(PackUriHelper.ForwardSlashString, StringComparison.Ordinal))
                    return false;
                ...
                if (zipItemName.EndsWith(PackUriHelper.ForwardSlashString, StringComparison.Ordinal))
                    return false;
                else
                    return true;
            }
